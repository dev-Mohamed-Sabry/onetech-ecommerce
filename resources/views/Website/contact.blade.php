...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/website/styles/contact_styles.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/website/styles/contact_responsive.css') }}">
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div
                        ...
                        <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                            <div class="contact_info_image"><img src="{{ asset('assets/website/images/contact_1.png') }}"
                                    alt=""></div>
                        ...
                        <!-- Contact Item -->
                        <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                            <div class="contact_info_image"><img src="{{ asset('assets/website/images/contact_2.png') }}"
                                    alt=""></div>
                            <div class="contact_info_content">
                        ...
                        <!-- Contact Item -->
                        <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                            <div class="contact_info_image"><img src="{{ asset('assets/website/images/contact_3.png') }}"
                                    alt=""></div>
                            <div class="contact_info_content">
