...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/website/styles/blog_styles.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/website/styles/blog_responsive.css') }}">
@endsection
                    ...
                    <div class="blog_posts d-flex flex-row align-items-start justify-content-between">
                        ...
                        <div class="blog_post">
                            <div class="blog_image"
                                style="background-image:url({{ asset('assets/website/images/blog_1.jpg') }})"></div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image"
                                style="background-image:url({{ asset('assets/website/images/blog_2.jpg') }})"></div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image"
                                style="background-image:url({{asset('assets/website/images/blog_3.jpg')}})"></div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image"
                                style="background-image:url({{asset('assets/website/images/blog_4.jpg')}})"></div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image"
                                style="background-image:url({{asset('assets/website/images/blog_5.jpg')}})"></div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image"
                                style="background-image:url({{asset('assets/website/images/blog_6.jpg')}})"></div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image"
                                style="background-image:url({{asset('assets/website/images/blog_7.jpg')}})"></div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image"
                                style="background-image:url({{asset('assets/website/images/blog_8.jpg')}})"></div>
                        ...
                        <div class="blog_post">
                            <div class="blog_image"
                                style="background-image:url({{asset('assets/website/images/blog_9.jpg')}})"></div>
