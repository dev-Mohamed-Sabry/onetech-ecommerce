...
<body>
    ...
    <div class="ht-100v bg-sl-primary d-flex align-items-center justify-content-center">
        <div class="wd-lg-70p wd-xl-50p tx-center pd-x-40">
            ...
            <h5 class="tx-xs-24 tx-normal tx-info mg-b-30 lh-5">You are not authorized to view this page.</h5>
            <p class="tx-16 mg-b-30 tx-white-5">The page you are looking for is not available</p>
