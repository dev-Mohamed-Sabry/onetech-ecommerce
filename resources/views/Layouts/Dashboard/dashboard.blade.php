...
<body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="#"><i class="icon ion-android-star-outline"></i> One-Tech</a>
    </div>
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('categories.create') }}" class="nav-link">Add
                        Category</a></li>
                <li class="nav-item"><a href="{{ route('categories.index') }}" class="nav-link">View Categories</a></li>
            </ul>
            <a href="#" class="sl-menu-link">
                <div class="sl-menu-item">
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{ route('products.index') }}" class="nav-link">View Products</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{ route('featured-products.create') }}" class="nav-link">Add</a></li>
                <li class="nav-item"><a href="alerts.html" class="nav-link">View</a></li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="notifications" role="tabpanel">
                <div class="media-list">
                    ...
                    <a href="" class="media-list-link read">
                        <div class="media pd-x-20 pd-y-15">
                            <img src="{{ asset('assets/dashboard/img/img10.jpg') }}" class="wd-40 rounded-circle"
                                alt="">
                            <div class="media-body">
    ...
    <footer class="sl-footer">
        <div class="footer-left ms-5" style="margin-left: 14.5rem;">
    ...
    <script src="{{ asset('assets/dashboard/lib/chart.js/Chart.js') }}"></script>
    <script src="{{ asset('assets/dashboard/lib/Flot/jquery.flot.js') }}"></script>
    <script src="{{ asset('assets/dashboard/lib/Flot/jquery.flot.pie.js') }}"></script>
    <script src="{{ asset('assets/dashboard/lib/Flot/jquery.flot.resize.js') }}"></script>
    <script src="{{ asset('assets/dashboard/lib/flot-spline/jquery.flot.spline.js') }}"></script>
